                ...
                <div className="categories-container">
                    ...
                    <div className="card-container">
                        <Link to={"products/category/macetas"} className="link-router">
                            <div className="categories b-radius" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="50">
                        ...
                        <Link to={"products/category/utensilios"} className="link-router">
                            <div className="categories b-radius" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="250">
                        ...
                        <Link to={"products/category/combos"} className="link-router">
                            <div className="categories b-radius" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="400">
                                <img src={baseUrl + catImage[4].image1} alt="categoria-macetas" className="category-img b-radius" />
