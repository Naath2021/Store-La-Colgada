...
const ProductsMock = [
    ...
    {
        category:"macetas", id: "2", name: "Gravity",
    ...
    {
        category:"utensilios", id: "3", name: "Posador Bubbles",
    ...
    {
        category:"macetas", id: "4", name: "Snowhite",
        price: 4700, description: "maceta de cerámica con colgantes de cuero. Medidas aproximadas: 15cm x 15cm.",
        image1: Snowhite1, image2: Snowhite2, image3: Snowhite3
    },

    {
        category:"utensilios", id: "5", name: "Colador Volcano",
    ...
    {
        category:"platos", id: "6", name: "Kitty Bubbles",
    ...
    {
        category:"combos", id: "7", name: "Jarra + filtro Garrita",
    ...
    {
        category:"combos", id: "8", name: "Juego de plato y Vaso Salpicrete",
    ...
    {
        category:"platos", id: "9", name: "Platos Monroe",
    ...
    {
        category:"ceniceros", id: "10", name: "cenicero carita",
    ...
    {
        category:"platos", id: "11", name: "Posador Primavera",
    ...
    {
        category:"ceniceros", id: "12", name: "ceniceros i see you ",
    ...
    {
        category:"combos", id: "13", name: "Set Merienda ",
        price: 2000, description: "el set incluye una jarra de 9 litro, dos tazas grandes de garrita y un posador.",
